...
RUN curl -Lo /usr/local/bin/telegram_backup-$TG_VERSION.jar https://github.com/fabianonline/telegram_backup/releases/download/$TG_VERSION/telegram_backup.jar
